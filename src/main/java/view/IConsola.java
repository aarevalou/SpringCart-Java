...
public class IConsola {
    ...
    public static void mostrarMenuAgregarProducto() {
        ...
        GestorMySQL.insertarRegistro("Producto", GestorObjeto.obtenerAtributosObjeto(p));
        ...
        for (HashMap.Entry<String, String> atributo : atributos.entrySet()){
            ...
            HashMap atributo_id = GestorMySQL.obtenerRegistro("Atributo", "nombre", String.valueOf(atributo.getKey()));
            registro.put("producto_id", String.valueOf(p.getId()));
        }
        GestorMySQL.insertarRegistro("Atributo_Producto", p.getAtributos());
    ...
    private static Usuario crearUsuario(Usuario usuario) {
        ...
        if(usuario instanceof Cliente){
            ...
            GestorMySQL.insertarRegistro("Cliente", GestorObjeto.obtenerAtributosObjeto(cliente));
        }
        if(usuario instanceof Admin){
            Admin admin = new Admin(rut, nombre, email,password, "", "asdf", "Adminaistrador de productos", GestorUsuarios.obtenerFechaActual());
            GestorMySQL.insertarRegistro("Admin", GestorObjeto.obtenerAtributosObjeto(admin));
        }
