...
public class GestorProductos {
    ...
    public static void setAtributosExtras() {
        ...
        for (int i = 0; i < GestorMySQL.obtenerCantidadRegistros("Atributo"); i++) {
            HashMap<String, String> atributo = GestorMySQL.obtenerRegistro("Atributo", "id", String.valueOf(i+1));
    ...
    public static void setProductos() {
        ...
        for (int i = 0; i < GestorMySQL.obtenerCantidadRegistros(tabla); i++) {
            ...
            producto.setModelo(registros.get("detalle"));
